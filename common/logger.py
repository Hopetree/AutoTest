...
class Logger(object):
    ...
    def __init__(self, log_path, log_file_name, console_output_level='INFO',
        ...
        self.log_file_name = os.path.join(log_path, log_file_name)
...
logger = Logger(LOG_CONFIG['log_path'], LOG_CONFIG['log_file_name'],
                LOG_CONFIG['console_output_level'],
                LOG_CONFIG['file_output_level'],
                LOG_CONFIG['backup_count']).get_logger()
